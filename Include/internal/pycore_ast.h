...
typeparam_ty _PyAST_TypeVar(identifier name, expr_ty bound, expr_ty default_,
                            int lineno, int col_offset, int end_lineno, int
                            end_col_offset, PyArena *arena);
typeparam_ty _PyAST_ParamSpec(identifier name, expr_ty default_, int lineno,
                              int col_offset, int end_lineno, int
                              end_col_offset, PyArena *arena);
typeparam_ty _PyAST_TypeVarTuple(identifier name, expr_ty default_, int lineno,
                                 int col_offset, int end_lineno, int
                                 end_col_offset, PyArena *arena);
